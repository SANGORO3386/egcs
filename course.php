...
<body id="page-top" onload="ajaxRequestToGetCourse();">
            ...
            <?php include("../../service/header.php");?>
                ...
                <div class="container-fluid">
					...
					<div>
                        ...
                        <select class="form-control" id="myclass" name="myclass" onchange="ajaxRequestToGetCourse();"><?php  
                        ...
                        ?>
                            ...
                            <div class="col-md-8">
                            <select id="mycourse" class="form-control" onchange="ajaxRequestToGetCourseInfo();" name="mycourse"></select>
                            </div>
                        </div>
