            ...
            <?php include("../../service/header.php");?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update Class Attendance</h1>
                        <a href="dashboard.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-arrow-left fa-sm text-white-50"></i> Dashboard</a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3">
                            <select id="myclass" class="form-control" name="myclass" onchange="ajaxRequestToGetMyCourse();">
								<?php  
					...
					?>
                        ...
                        <div class="col-md-8 mb-3">
                            <select id="mycourse" class="form-control" onchange="" name="mycourse"></select>
                        </div>
                            <div class="col-md-4">
                        Select Student:
                        </div>
                        <div class="col-md-8 mb-3">
                            <select id="mystudent" class="form-control" onchange="" name="mystudent"></select>
                        </div>
					    <div class="col-md-4">
                         Date:
                        </div>
                        <div class="col-md-8 mb-3">
                            <input  type="date" class="form-control" id="datepicker" name="date"/></br>
